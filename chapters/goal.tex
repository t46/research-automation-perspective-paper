...
In this section, I will briefly explore the concept of verification to provide seeds of thought. Since I have already discussed what verification, i.e., justification, is in Section \ref{section-what-is-research}, I will skip that discussion here. Instead, in this section, I will discuss elements that seem important when conducting human-like verification, particularly experimentation in science and statistical hypothesis testing.
...
Additionally, there is an initiative known as \textit{laboratory automation} that attempts to automate experiments, including the execution of experiments, which, as mentioned earlier, is a challenging aspect. A notable example is pioneering research in genetics by King et al., who fully automated the cycle of hypothesis generation, verification, and discovery of new hypotheses \cite{king2004functional}. Another example is A.I. Cooper, which enabled the use of the same experimental equipment as humans through autonomous robots \cite{burger2020mobile}. 
...
I have been speculatively discussing the construction of questions, generation of hypotheses, and verification of hypotheses, which are the elements of research. Looking back at completed studies, we can indeed find that each study had its own question, a hypothesis for that question, and a verification for that hypothesis. From this perspective, it can be said that research is an endeavor consisting of the continuous process of constructing questions, generating hypotheses, and verifying hypotheses, as has been classically described.

On the other hand, actual research is an extremely complex process of trial and error, and it is rare for the construction of a question, generation of a hypothesis, and verification of a hypothesis to be done only once each in a single study as initially anticipated. In reality, for example, countless questions and hypotheses are generated even for formulating a single hypothesis, and not all of them necessarily lead to the final research outcome. It is more appropriate to view the construction of questions, generation of hypotheses, and verification of hypotheses as basic operations to reduce uncertainty, and to see them as intricately combined to reduce the uncertainty of larger research problems. Especially in the heuristic work of constructing questions and generating hypotheses, these trial-and-error elements are considered to become more important
