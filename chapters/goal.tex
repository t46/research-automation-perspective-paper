...
A widely accepted definition of research would be that research is the act of generating new knowledge. It seems that research, regardless of the field, requires some novelty, and it feels reasonable to say that research is an act of creating knowledge based on past knowledge. Thus, I will tentatively adopt this definition as the working definition in this paper. In particular, I will consider that research is the production of new knowledge for society. I included ``for society'' because knowledge appears to be relative to society, as I will discuss later. 
...
A belief of an individual is not generally considered as knowledge in research. It seems that it is required for other people also share that belief. That is, the knowledge generated through research seems to be required to be knowledge for humanity. 

% Even if it is a strong belief, one person's belief is not recognized as knowledge unless other researchers gain a similar level of conviction from the research. Beliefs, knowledge, and understanding are indeed subjective concepts by nature, but it seems that we demand that they go beyond subjectivity and become comprehensible to others as well. 

Therefore, in research, justification must update not only an individual's but also other people's beliefs in the same direction. I believe that humans achieve this by backing the validity of a weak belief, such as ``a certain hypothesis might be true'', with strong beliefs that are so fundamental that everyone, simply by being human, holds them, and without which, they could not even go about their daily lives.
...
% fully autonomous artificial researcher would likely produce nonsense for humans. This is because, even if a group of agents grounds their justifications in solid shared beliefs, it would be mere gibberish for humans if the belief is not shared among humans.\footnote{
...
% 自律的に研究ができる人工知能を目指す際に、どこまで人工知能に任せることができるか、すなわち自律性の限界はどこにあるのかというのは重要な点です。これらの結論を踏まえると、この定義の意味での研究を AI にやらせる時には、検証の概念的な土台から AI に作らせることは難しそうであることがわかりました。検証については後のセクションでもう少し詳しく議論しようと思います。
...
\subsubsection{Complex Activities}
