...
What I am aiming for is an artificial intelligence that can conduct research completely autonomously. Therefore, the ultimate aim is to minimize predetermined modules or algorithms decided by humans and create an end-to-end system. With that in mind, I would like to express my opinion on how much autonomy should be pursued.
...
\subsection{How to Identify the Necessary Knowledge for Achieving a Goal?}
...
\subsection{How to Search Necessary Knowledge and Recognize the Lack of Knowledge?}
...
\subsection{Multiple Reasons for Unknownness}
new, unimportant, difficult, unnoticed, ... etc.

\subsection{Finding ``Important'' but Unnoticed Questions}
